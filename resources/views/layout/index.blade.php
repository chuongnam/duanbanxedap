...
<html lang="en">
  ...
  @yield('title')
            ...
            <div class="left-sidebar-scroll">
              <div class="left-sidebar-content">
                <ul class="sidebar-elements">
                  ...
                  <li class="parent"><a href="{{route('cate.list')}}"><i class="icon mdi mdi-chart-donut"></i><span>Quản lí CATEGORIS</span></a>
                  
                  </li>
                  <li class="parent"><a href="{{route('km.list')}}"><i class="icon mdi mdi-dot-circle"></i><span>Quản lí Khuyến Mãi</span></a>
                 
                  </li>
                  <li class="parent"><a href="{{route('cartt.show')}}" class="parent"><i class="icon mdi mdi-border-all"></i><span>Quản lí Đơn Hàng</span></a>
                    
                  </li>
                  <li class="parent"><a href="{{route('carss.show')}}" class="parent"><i class="icon mdi mdi-border-all"></i><span>Quản lí Sản Phẩm</span></a>
                    
                    </li>
                    <li class="parent"><a href="{{route('ban.show')}}" class="parent"><i class="icon mdi mdi-border-all"></i><span>Quản lí Banner</span></a>
    ...
    <script src="{{asset('assets\lib\bootstrap\dist\js\bootstrap.bundle.min.j')}}s" type="text/javascript"></script>
    <script src="{{asset('assets\js\app.js')}}" type="text/javascript"></script>
    <script src="{{asset('assets\lib\jquery-flot\jquery.flot.j')}}s" type="text/javascript"></script>
